//package com.xqx.small.enroll.service.impl;
//
//import com.xqx.small.enroll.service.IEnrollService;
...
//            reduceMajorNumberReq.setEnrollId(confirmEnrollReq.getCouponId());
...
//            //4.远程调用失败，则发送MQ消息
//            try {
//                CancelEnrollMQ cancelEnrollMQ = new CancelEnrollMQ();
...
//                //JSONArray.toJSONString(cancelEnrollMQ);
//
...
//     * 参数校验
//     * @param confirmEnrollReq
//     * @param queryOrgMajorRes
//     *
//     * 【注意：】这里统一抛出 运行时异常，这样spring才能中断程序
//     */
//
